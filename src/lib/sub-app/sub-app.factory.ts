...
import { DEFAULT_APP_NAME, DEFAULT_APPS_PATH, DEFAULT_DIR_ENTRY_APP, DEFAULT_LANGUAGE, DEFAULT_LIB_PATH, DEFAULT_PATH_NAME, PROJECT_TYPE, TEST_ENV } from '../defaults';
